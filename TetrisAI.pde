...
void draw() {
    ...
    if(HUMAN_PLAY) {
      ...
      text("Taux de mutation : "+mutation_rate*100+"%",100,500);
      text("Individus : "+pop.best_tetris.species_id, 100,540);
    }
    show();
}
